...
/**
 * [Dictionary view][DictionaryViewEntity] linked with all of its associated [data categories][CategoryEntity]
 *
 * _Note_: Instances of this class can be auto-generated by Room.
 */
internal data class DictionaryViewWithCategories(
    /** [Dictionary view][DictionaryViewEntity] */
    @Embedded val dictionaryView: DictionaryViewEntity,
    /** List of [categories][CategoryEntity] associated with this dictionary view */
    @Relation(
        parentColumn = "id",
        entityColumn = "id",
