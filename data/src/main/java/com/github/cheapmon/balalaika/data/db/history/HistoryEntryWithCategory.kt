...
/**
 * [History entry][HistoryItemEntity] optionally linked with a [category][CategoryEntity] if the search has
 * been restricted
 *
 * _Note_: Instances of this class can be auto-generated by Room.
 */
internal data class HistoryEntryWithCategory(
    /** [History entry][HistoryItemEntity] */
    @Embedded val historyEntry: HistoryItemEntity,
